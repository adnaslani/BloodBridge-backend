...
if (process.env.NOTIFICATION_WORKER_ENABLED === "true" && !process.env.NOTIFICATION_WEBHOOK_URL) {
  throw new Error("NOTIFICATION_WEBHOOK_URL must be set when NOTIFICATION_WORKER_ENABLED=true");
}
