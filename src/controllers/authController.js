...
const registerWithCognito = asyncHandler(async (req, res) => res.status(201).json(await authService.registerWithCognito(req.body)));
...
module.exports = { register, registerWithCognito, login, logout, syncCognitoUser };
